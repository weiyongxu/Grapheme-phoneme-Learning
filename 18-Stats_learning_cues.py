...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 12 14:44:27 2019
...
cond_A='IDX3/Learning/UNKNOWN'
cond_B='IDX3/Learning/NO'
...
for view in ['lat', 'med', 'ros', 'cau', 'dor', 'ven', 'fro', 'par']:
    ...
    brain = stc_all_cluster_vis.plot(hemi=hemi, views=view,smoothing_steps=5,
                                     ...
                                     )#clim=dict(kind='value',lims=[50, 100, 200])
    
    #indt=0
    #brain.set_data_time_index(indt)
    brain.save_single_image(Folder_name+File_Name+str(day)+'_'+view+hemi+'.pdf')
    brain.close()