...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 29 10:27:04 2019
...
cond_A='RG_LB_Auditory_IDX0'
cond_B='RG_UB_Auditory_IDX0'
...
for view in ['lat', 'med', 'ros', 'cau', 'dor', 'ven', 'fro', 'par']:
    ...
    brain = stc_all_cluster_vis.plot(hemi='rh', views=view,smoothing_steps=5,
